...
dotted black bags contain no other bags.", "shiny gold", 4)]
        [InlineData(@"drab tan bags contain 4 clear gold bags.
...
dim chartreuse bags contain 3 shiny gold bags, 2 mirrored olive bags.", "shiny gold", 370)]
        public void CountColorsTest(string input, string search, int expected)
        {
            Assert.Equal(expected, BagHelper.CountDistinctWhereSearchInColors(input, search));
        }
...
striped plum bags contain 5 dim white bags, 4 dark teal bags.
dim lavender bags contain 5 striped bronze bags, 3 wavy maroon bags.
dim chartreuse bags contain 3 shiny gold bags, 2 mirrored olive bags.", "shiny gold", 29547)]
        public void FindBagsInsideTest(string input, string search, int expected)
        {
            Assert.Equal(expected, BagHelper.CountBagsInsideSearch(input, search));
        }
    }
}